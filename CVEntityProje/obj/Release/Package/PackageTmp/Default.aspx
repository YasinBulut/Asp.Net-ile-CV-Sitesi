...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="/web/images/about.png" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="index.html">YASİN BULUT</a></h1>
            <p class="top_hdp mt-2">KBU~MEKATRONİK MÜHENDİSİ</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
            ...
            <h3 class="w3_head mb-4 text-left">İLETİŞİM</h3>
                ...
                <form action="#" method="post" runat="server">
                    <div class="row contact_top">
                     ...
                     <asp:TextBox ID="TextBox3" runat="server" placeholder="Konu Başlığı" ></asp:TextBox>
                      <asp:TextBox ID="TextBox4" runat="server" placeholder="Mesajınız  " TextMode="MultiLine" Height="75"></asp:TextBox>
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-info" Text="GÖNDER" OnClick="Button1_Click" />
                     <asp:Button ID="Button2" runat="server" CssClass="btn btn-info" Text="VAZGEÇ" OnClick="Button2_Click" />
