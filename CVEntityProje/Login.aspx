			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" runat="server">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
					 ...
					 <asp:TextBox ID="TextBox1" runat="server" class="input100" placeholder="Kullanı Adınız"></asp:TextBox>
					...
					&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="Button2" runat="server" Text="Web Sayfası" class="login100-form-btn" OnClick="Button2_Click" Width="161px" />
					</div>
				</form>
			</div>
		</div>
